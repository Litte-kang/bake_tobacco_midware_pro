...
function updateFw(serPort, serIP, cmdInfo, innerPort)
{
	...
	if (100 === cmdInfo.data[2])
	{
		fwInfos.resrcPath = "-P ./fws/fw_" + cmdInfo.data[2] + " " + SER_PATH + serIP + '/arm/' + cmdInfo.data[2] + '/' + cmdInfo.data[2] + "." + cmdInfo.data[1] + ".fw";
	}
	else
	{
		fwInfos.resrcPath = "-P ./fws/fw_" + cmdInfo.data[2] + " " + SER_PATH + serIP + '/' + cmdInfo.data[2] + '/' + cmdInfo.data[2] + "." + cmdInfo.data[1] + ".fw";
	}
